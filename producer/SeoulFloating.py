...
FILE_PATH = "../csv/SeoulFloating.csv"
...
def SeoulFloating_to_dict(SeoulFloating, ctx):
    """
...
def main(topic):
    ...
    my_schema = schema_registry_client.get_latest_version("SeoulFloating-value")
    string_serializer = StringSerializer('utf_8')

    my_str = my_schema.schema.schema_str
    print(my_str)
    json_serializer = JSONSerializer(my_str, schema_registry_client, SeoulFloating_to_dict)
