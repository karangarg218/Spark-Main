...
def main(topic):
    ...
    print(my_str)
    json_serializer = JSONSerializer(my_str, schema_registry_client, case_to_dict)
    ...
    producer.poll(0.0)
    try:
        for case in getcaseinstance(FILE_PATH):
            # print(car)
