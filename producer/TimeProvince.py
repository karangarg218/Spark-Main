...
FILE_PATH = "../csv/TimeProvince.csv"
...
def TimeProvince_to_dict(TimeProvince, ctx):
    """
...
def main(topic):
    ...
    print(my_str)
    json_serializer = JSONSerializer(my_str, schema_registry_client, TimeProvince_to_dict)
