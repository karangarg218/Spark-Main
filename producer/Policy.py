...
def getPolicyinstance(filePath):
...
def main(topic):
    ...
    my_schema = schema_registry_client.get_latest_version("policy-value")
    string_serializer = StringSerializer('utf_8')

    my_str = my_schema.schema.schema_str
    print(my_str)
    json_serializer = JSONSerializer(my_str, schema_registry_client, Policy_to_dict)
    ...
    producer.poll(0.0)
    try:
        for data in getPolicyinstance(FILE_PATH):
            # print(car)
