...
def SearchTrend_to_dict(SearchTrend, ctx):
    """
...
def main(topic):
    ...
    print(my_str)
    json_serializer = JSONSerializer(my_str, schema_registry_client, SearchTrend_to_dict)
