...
def main(topic):
    ...
    collection=get_mongo(db="kafka",collection="TimeAge")
    while True:
        try:
            # SIGINT can't be handled when polling, limit TimeAgeout to 1 second.
